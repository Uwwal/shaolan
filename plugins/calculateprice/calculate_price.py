from config.constant import dian_wum_recycle_price, dian_rarity, yi_wum_recycle_price, yi_rarity
from models.wum_pool import system_inventory


def calculate_price(rarity, rarity_weight_, base_sum_coin):
    ...
    return final_price_list[rarity - 1]